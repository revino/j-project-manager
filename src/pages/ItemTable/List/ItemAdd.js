...
console.log(props);
  ...
  const [pjtname, onChangePjtname, isPjtNameValid] = useInput({initialValue:""});
      ...
      <h2 id="simple-modal-title">아이템 추가</h2>
        ...
        <Grid container className={classes.section2}>
          <Grid item lg={2} md={6} sm={6} xl={2} xs={12} container>
            <DatePicker componentKey="start" label={"시작일"} value={startDate} onChange={onChangeStartDate}/>
          </Grid>
          <Grid item lg={2} md={6} sm={6} xl={2} xs={12} container>
            <DatePicker componentKey="end" label={"종료일"} value={endDate} onChange={onChangeEndDate}/>
          </Grid>
        </Grid>
        ...
        <Grid container className={classes.section3}>
          <Grid item lg={12} md={12} sm={12} xl={12} xs={12} container>
            <TextField error={selectError.pjtno || !isPjtNoValid} className={classes.textarea} id="pjt no" label="PJT No" helperText="Project 번호" variant="standard" value={pjtno} onChange={onChangePjtno}/>
          </Grid>
          <Grid item lg={12} md={12} sm={12} xl={12} xs={12} container> 
            <TextField error={selectError.pjtname || !isPjtNameValid} className={classes.textarea} id="pjt name" label="PJT Name" helperText="Project 이름" variant="standard" value={pjtname} onChange={onChangePjtname}/>
          </Grid>

          <Grid item lg={12} md={12} sm={12} xl={12} xs={12} container>
            <TextareaAutosize className={classes.textarea} aria-label="minimum height" rowsMin={10} rowsMax={50} placeholder="내용 입력" value={content} onChange={onChangeContent}/>
          </Grid>
        </Grid>
        <Grid item lg={12} md={12} sm={12} xl={12} xs={12} container>
